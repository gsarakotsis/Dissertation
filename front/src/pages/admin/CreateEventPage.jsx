    ...
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
          <Link to="/dashboard" style={{ color: '#d0d0d0', textDecoration: 'none', fontSize: '15px' }}>
            Dashboard
          </Link>
      ...
      <section style={{ backgroundColor: '#1a1a1a', color: '#ffffff', padding: '40px 30px' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '36px', fontWeight: '700', marginBottom: '10px' }}>Add New Event</h1>
          <p style={{ fontSize: '16px', color: '#d0d0d0' }}>Create a new event for your department or organization</p>
        </div>
      </section>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '25px' }}>
              ...
              <div style={{ fontSize: '13px', color: '#888', marginTop: '8px' }}>
                Include information about speakers, agenda, target audience
              </div>
            </div>
            ...
            <div style={{ marginBottom: '25px' }}>
              ...
              <div style={{ display: 'flex', gap: '30px' }}>
                {[
                  ...
                  <label key={opt.value} style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', fontSize: '15px' }}>
            ...
            <div style={{ marginBottom: '25px' }}>
              ...
              <label htmlFor="photo-upload" style={{
                ...
                <div style={{ textAlign: 'center', fontSize: '15px', color: '#666' }}>
                  ...
                  <br />
                  <span style={{ fontSize: '13px' }}>PNG, JPG or JPEG (max 5MB)</span>
                </div>
              </label>
